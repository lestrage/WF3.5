function WorkflowDesigner(e) {
    var t = this;
    this.Settings = e, window.localStorage || WorkflowDesignerCommon.defineLocalStorage(), this.GetName = function () {
        ...
        var i = new Array;
        this.loadParams = e, this.schemecode = e.schemecode, this.processid = e.processid, this.schemeid = e.schemeid, e.readonly && (this.Settings.readonly = e.readonly), i.push({
            name: "schemecode",
        ...
        $.ajax({
            ...
            success: function (i) {
                ...
                if (n.isError) return void t.error(n.errorMessage);
                n.__loadParams = e, t.data = n, t.render()
            },
        ...
        $.ajax({
            method: "GET",
            url: this.Settings.apiValueActorUrl,
            success: function (e) {
                t.roles = e.data;
            },
            error: function (e) {
        ...
        $.ajax({
            method: "GET",
            url: this.Settings.apiCommandUrl,
            success: function (e) {
                t.commands = e.data;
            },
            error: function (e) {
        ...
        var i = new Array;
        this.schemecode = e.schemecode, this.processid = e.processid, this.schemeid = e.schemeid, e.readonly && (this.Settings.readonly = e.readonly), i.push({
            name: "schemecode",
            value: this.schemecode
        }), i.push({
            name: "processid",
        ...
        var e = !1;
        t.Graph && (t.Graph.destroy(), void 0 != t.data && void 0 != t.data.__loadParams && (void 0 != t.data.__loadParams.isFullScreen && (e = t.data.__loadParams.isFullScreen), void 0 != t.data.__loadParams.readonly && (this.Settings.readonly = t.data.__loadParams.readonly)));
        var i = [WorkflowDesignerActivityManager, WorkflowDesignerTransitionManager, WorkflowDesignerKeyboard];
        if (this.Settings.printable || i.push(WorkflowDesignerBackground), this.Settings.notrendertoolbar || i.push(WorkflowDesignerToolbar), t.Settings.printable && void 0 != t.data) {
            var n = 0,
                o = 0;
            $(t.data.Activities).each(function (e) {
                var t = parseInt(this.DesignerSettings.X),
                    i = parseInt(this.DesignerSettings.Y);
                t > n && (n = t), i > o && (o = i)
            }), t.Settings.graphwidth = n + t.Settings.DefaultActivityWidth, t.Settings.graphheight = o + t.Settings.DefaultActivityHeight
        }
        t.Graph = new WorkflowGraph(this.Settings.renderTo, t, t.Settings, i), t.Graph.setFullScreen(e), void 0 != t.data && (WorkflowDesignerCommon.DataCorrection(t.data), void 0 != t.data.__loadParams && void 0 != t.data.__loadParams.graphData && (t.Graph.graphData = t.data.__loadParams.graphData, t.Graph.graphDataIndex = t.data.__loadParams.graphDataIndex), t.Graph.Draw(t.data))
    }, this.save = function (e) {
        if (t.Settings.readonly) return void alert(WorkflowDesignerConstants.ErrorReadOnlySaveText);
        var i = new Array;
        i.push({
            name: "schemecode",
            value: this.schemecode
        ...
        $.ajax({
            ...
            success: function (i) {
                ...
                if (n.isError) return void t.error(n.errorMessage);
                t.data = n, t.render(), e && setTimeout(function () {
                    e(t)
                }, 100)
            }
        })
        ...
        o.setAttribute("id", n), o.setAttribute("name", n), o.setAttribute("width", "0"), o.setAttribute("height", "0"), o.setAttribute("border", "0"), o.setAttribute("style", "width: 0; height: 0; border: none;"), e.parentNode.appendChild(o), window.frames[n].name = n;
        var a = document.getElementById(n),
            r = function () {
                a.detachEvent ? a.detachEvent("onload", r) : a.removeEventListener("load", r, !1), a.contentDocument ? content = a.contentDocument.body.innerText : a.contentWindow ? content = a.contentWindow.document.body.innerHTML : a.document && (content = a.document.body.innerHTML), setTimeout(function () {
                ...
                if (e.isError) return void t.error(e.errorMessage);
                t.data = e, t.render(), i && i(t)
            };
        a.addEventListener && a.addEventListener("load", r, !0), a.attachEvent && a.attachEvent("onload", r), e.setAttribute("target", n), e.setAttribute("action", this.createurl("uploadscheme")), e.setAttribute("method", "post"), e.setAttribute("enctype", "multipart/form-data"), e.setAttribute("encoding", "multipart/form-data"), e.submit()
        ...
        var e = void 0;
        return 1 != $.grep(t.data.Activities, function (e) {
            return 1 == e.IsInitial
        }).length && (e = WorkflowDesignerConstants.ErrorActivityIsInitialCountText), e
    ...
    }, this.deleteGlobalCodeAction = function (e, i) {
        var n = new Array;
        n.push({
            name: "operation",
    ...
    }, this.uploadschemeBPMN = function (e, i) {
        var n = this.GetName() + "_uploadiframe",
            o = document.createElement("iframe");
        o.setAttribute("id", n), o.setAttribute("name", n), o.setAttribute("width", "0"), o.setAttribute("height", "0"), o.setAttribute("border", "0"), o.setAttribute("style", "width: 0; height: 0; border: none;"), e.parentNode.appendChild(o), window.frames[n].name = n;
        var a = document.getElementById(n),
        ...
        a.addEventListener && a.addEventListener("load", r, !0), a.attachEvent && a.attachEvent("onload", r), e.setAttribute("target", n), e.setAttribute("action", this.createurl("uploadschemebpmn")), e.setAttribute("method", "post"), e.setAttribute("enctype", "multipart/form-data"), e.setAttribute("encoding", "multipart/form-data"), e.submit()
    }
}
...
function WorkflowDesignerOverviewMap() {
    ...
    this.init = function (t) {
        ...
        var i = this.graph.Stage.width(),
            ...
            o = void 0 != this.graph.Settings.overviewMapWidth ? this.graph.Settings.overviewMapWidth : WorkflowDesignerConstants.OverviewMap.width,
            a = void 0 != this.graph.Settings.overviewMapHeight ? this.graph.Settings.overviewMapHeight : WorkflowDesignerConstants.OverviewMap.height;
...
function WorkflowDesignerForm(e) {
    this.type = "WorkflowDesignerForm", this.parameters = e, this.id = WorkflowDesignerCommon.createUUID(), this.isReadOnly = function () {
    ...
    }, this.showModal = function (e, t) {
        var i = this;
        i.window = $('<div tabindex="0" class="ui modal WorkflowDesignerDialog"></div>'), void 0 != WorkflowDesignerConstants.FormMaxHeight && "" != WorkflowDesignerConstants.FormMaxHeight && i.window.css("max-height", WorkflowDesignerConstants.FormMaxHeight), void 0 != this.parameters.width && "" != this.parameters.width && i.window.width(this.parameters.width), i.window.id = this.id;
        var n = void 0;
        "table" === this.parameters.type ? n = this.generateTable(this.parameters) : "form" === this.parameters.type && (n = this.generateForm(this.parameters)), void 0 == n && (n = new Array), void 0 != i.parameters.top && n.unshift(i.parameters.top), void 0 != i.parameters.bottom && n.push(i.parameters.bottom), void 0 != this.parameters.renderFinalFunc && this.parameters.renderFinalFunc(n, i);
        var o = i.getEditData(i.parameters);
        i.window.append($('<div class="header">' + this.parameters.title + "</div>")), i.window.append($('<div class="content scrolling"></div>').append(n));
        var a = $('<div class="actions"></div>');
        i.isReadOnly() ? a.append('<div class="ui secondary  cancel button">' + WorkflowDesignerConstants.ButtonTextClose + "</div>") : (a.append('<div class="ui primary ok button">' + WorkflowDesignerConstants.ButtonTextSave + "</div>"), a.append('<div class="ui secondary cancel button">' + WorkflowDesignerConstants.ButtonTextCancel + "</div>")), i.window.append(a);
        var r = function () {
            if (i.ClearError(), void 0 != e && !i.isReadOnly()) {
                return !!e(i.getEditData(i.parameters), i.parameters) && (i.allowDestroy = !0, !0)
            }
        },
            s = function () {
                if (!i.isReadOnly()) {
                    var e = i.getEditData(i.parameters);
                    return JSON.stringify(o) === JSON.stringify(e) ? (i.allowDestroy = !0, !0) : (i.ConfirmDialog(WorkflowDesignerConstants.CloseWithoutSaving, WorkflowDesignerConstants.ButtonTextYes, function () {
                        i.allowDestroy = !0, WorkflowDesignerCommon.modal(i.window, "hide")
                    }, WorkflowDesignerConstants.ButtonTextNo, function () {
                        return !0
                    }), !1)
                }
            };
        WorkflowDesignerCommon.modal(i.window, {
            closable: !1,
            onApprove: r,
            onDeny: s,
            allowMultiple: t,
            onHidden: function () {
                1 == i.allowDestroy && i.destroy()
            },
            dimmerSettings: {
                opacity: .2,
                duration: {
            ...
            transition: "fade"
        }), WorkflowDesignerCommon.modal(i.window, "show"), WorkflowDesignerCommon.modal(i.window, "refresh")
    }, this.destroy = function () {
        $(".WorkflowDesignerDialogautoComplete").remove(), this.window.remove()
    }, this.ConfirmDialog = function (e, t, i, n, o) {
        var a = $('<div tabindex="0" class="ui mini modal WorkflowDesignerConfirmDialog"></div>');
        a.append($('<div class="header">' + WorkflowDesignerConstants.DialogConfirmText + "</div>")), a.append($('<div class="content scrolling"><p>' + e + "</p></div>"));
        ...
        a.append(r), WorkflowDesignerCommon.modal(a, {
            onApprove: function () {
                i()
            },
            onDeny: function () {
        ...
        void 0 != i && (n += " " + i);
        var o = $('<div tabindex="0" class="' + n + '"></div>');
        o.append($('<div class="header">' + e + "</div>")), o.append($('<div class="content scrolling"><p>' + t + "</p></div>"));
        var a = $('<div class="actions"></div>').append('<div tabindex="1" class="ui primary ok button">' + WorkflowDesignerConstants.EditCodeLabel.OK + "</div>");
        o.append(a), WorkflowDesignerCommon.modal(o, {
            allowMultiple: !0,
            dimmerSettings: {
                opacity: .2,
                duration: {
        ...
        if ("form" == e.type || "group" == e.type) t = {}, e.elements.forEach(function (e) {
            void 0 != e.field && (t["control_" + e.field] = e.control), "table" == e.type || "form" == e.type ? t[e.field] = i.getEditData(e) : "group" == e.type ? i.objAssign(t, i.getEditData(e)) : i.SetValueByPropertyName(t, e.field, i.getEasyControlValue(e))
        });
            ...
            if (e.elements.forEach(function (e) {
                ...
                for (var o = n.children("tbody").children("tr"), a = 0; a < o.length; a++) void 0 == t[a] && (t[a] = {}), t[a].keyproperty = $(o[a]).attr("keyproperty")
        }
        return t
        ...
        return e.elements.forEach(function (n) {
            var a = $('<div class="field">');
            void 0 != n.width && a.width(n.width), void 0 == t && (t = "");
            var r = t + "_" + n.field,
                s = void 0;
            if (void 0 != n.name && (s = $("<label></label>"), s[0].innerHTML = n.name, a.append(s)), "table" == n.type) {
                ...
                var d = i.generateEasyControls(n, i.GetValueByPropertyName(e.data, n.field), r);
                void 0 != s && (s[0].for = d[0].id), n.control = d[0], a.append(d[0])
            }
            o.push(a)
        ...
        e.elements.forEach(function (e) {
            var t = $("<th></th>");
            t[0].innerHTML = e.name, void 0 != e.width && (t[0].width = e.width), a.append(t)
        }), this.isReadOnly() || a.append("<th></th>"), o.append(a), n.append(o);
        var r = function (o) {
            void 0 != e.beforerowadded && e.beforerowadded(o, i);
            var a = $("<tr></tr>");
            e.keyproperty && a.attr("keyproperty", o[e.keyproperty]), void 0 == t && (t = "");
            var r = t + WorkflowDesignerCommon.createUUID();
            if (e.elements.forEach(function (e) {
                if ("table" == e.type) {
                    e.fieldFunc ? e.data = e.fieldFunc(o) : e.data = o[e.field];
                    var t = i.generateTable(e, r);
                    a.append($("<td></td>").append(t))
                } else {
                    var n = i.generateEasyControls(e, i.GetValueByPropertyName(o, e.field), r, o);
                    a.append($("<td></td>").append(n))
                }
            }), !i.isReadOnly()) {
                var s = $('<a class="btnDelete"></a>');
                s[0].innerHTML = WorkflowDesignerConstants.ButtonTextDelete, s[0].href = "#", s.on("click", function () {
                    return (void 0 == e.onrowdelete || 0 != e.onrowdelete(a, i)) && (a.remove(), WorkflowDesignerCommon.modal(i.window, "refresh"), !1)
                }), a.append($("<td></td>").append(s))
            }
            n.append(a), void 0 != e.onrowadded && e.onrowadded(a, i)
        };
        ...
        if (s.push(n), !this.isReadOnly()) {
            var l = $('<a class="btnAdd"></a>');
            l[0].innerHTML = WorkflowDesignerConstants.ButtonTextCreate, l[0].href = "#", l.on("click", function () {
                var t = {};
                return e.datadefault && (t = e.datadefault), r(t), WorkflowDesignerCommon.modal(i.window, "refresh"), !1
            }), s.push(l)
        }
        return s
        ...
        var o = this;
        if ("input" === e.type) {
            var a = $('<input type="text"></input>');
            return a[0].id = this.generateid(e.field, i), a[0].name = o.getElementCode(e), void 0 != t && (a[0].value = t), o.isReadOnly() && a.attr("readonly", !0), this.addAutoComplete(e, a), a
        }
        if ("checkbox" === e.type) {
            var a = $('<input type="checkbox"></input>');
            return a[0].id = this.generateid(e.field, i), a[0].checked = t, a[0].name = o.getElementCode(e), o.isReadOnly() && a.attr("disabled", "disabled"), a = $('<div class="ui checkbox"></div>').append(a).append("<label></label>")
        }
        if ("select" == e.type) {
            var a = $('<select class="ui selection dropdown"></select>');
            return a[0].id = this.generateid(e.field, i), a[0].name = o.getElementCode(e), a.append($("<option></option>")), void 0 != e.datasource && e.datasource.forEach(function (i) {
                var n = $("<option></option>");
                void 0 == e.displayfield ? (n[0].value = i, n[0].innerHTML = i) : (n[0].value = i[e.displayfield], n[0].innerHTML = i[e.displayfield]), n[0].value == t && (n[0].selected = "selected"), o.isReadOnly() && a.attr("disabled", "disabled"), a.append(n)
            }), a
        }
        if ("textarea" === e.type) {
            var a = $('<textarea rows="6" style="width: 100%;"></textarea>');
            return a[0].id = o.generateid(e.field, i), a[0].name = o.getElementCode(e), void 0 != t && (a[0].value = t), this.isReadOnly() && a.attr("readonly", !0), a
        }
        return "json" === e.type ? o.generateJSONControl(e, t, i, n) : "code" === e.type ? o.generateCodeControl(e, t, i, n) : void 0
    }, this.generateJSONControl = function (e, i, n, o) {
        var a = $('<input type="text"></input>');
        a[0].id = this.generateid(e.field, n), a[0].name = t.getElementCode(e), void 0 != i && (a[0].value = i), t.isReadOnly() && a.attr("readonly", !0);
        var r = $('<a class="btnCodeActions"></a>');
        r[0].id = a[0].id + "_button";
        var s = $('<div class="ui modal WorkflowDesignerDialogChild"><div class="header">' + WorkflowDesignerConstants.EditJSONLabel.Title + '</div><div id="' + a[0].id + '_editor" style="height:' + WorkflowDesignerConstants.EditJSONSettings.CodeHeight + 'px">' + a[0].value + "</div></div>");
        s[0].id = a[0].id + "_form";
        var l = $('<div class="actions"></div>');
        if (!a[0].readOnly) {
            var d = $('<div class="ui button">' + WorkflowDesignerConstants.EditJSONLabel.Format + "</div>");
            d.click(function () {
                var e = ace.edit(a[0].id + "_editor"),
                    i = ace.edit(a[0].id + "_editor").getValue();
                e.setValue(t.toPrettyJSON(i)), e.clearSelection()
            }), l.append(d)
        }
        if (void 0 != e.getemptytype && !a[0].readOnly) {
            var c = $('<div class="ui button">' + WorkflowDesignerConstants.EditJSONLabel.CreateEmptyType + "</div>");
            c.click(function () {
                var i = e;
                void 0 != i.getemptytype && i.getemptytype(t, a[0], function (e) {
                    if (void 0 != e && "" !== e) {
                        var i = ace.edit(a[0].id + "_editor");
                        i.setValue(t.toPrettyJSON(e)), i.clearSelection()
                    }
                })
            }), l.append(c)
        }
        return a[0].readOnly ? l.append('<div class="ui secondary cancel button">' + WorkflowDesignerConstants.ButtonTextClose + "</div>") : (l.append('<div class="ui primary ok button">' + WorkflowDesignerConstants.ButtonTextSave + "</div>"), l.append('<div class="ui secondary cancel button">' + WorkflowDesignerConstants.ButtonTextCancel + "</div>")), s.append(l), r.on("click", function (e) {
            WorkflowDesignerCommon.modal(t.window, "hide"), WorkflowDesignerCommon.modal(s, {
                closable: !1,
                allowMultiple: !0,
                onApprove: function () {
                    var e = ace.edit(a[0].id + "_editor").getValue();
                    a[0].value = t.toCompactJSON(e)
                },
                onHidden: function () {
                    setTimeout(function () {
                ...
                transition: "fade"
            }), WorkflowDesignerCommon.modal(s, "show");
            var i = ace.edit(a[0].id + "_editor");
            a[0].readOnly ? i.setOptions({
                readOnly: !0
            }) : i.setOptions({
                readOnly: !1
            }), i.getSession().setMode("ace/mode/json"), i.setValue(t.toPrettyJSON(a[0].value)), i.clearSelection()
        }), this.addAutoComplete(e, a), $('<div style="width:100%;"></div>').append($('<div style="width:16px; float:right; margin-right:7px;margin-top: 10px;"></div>').append(r)).append($('<div style="margin-right:30px"></div>').append(a))
    }, this.generateCodeControl = function (e, i, n, o) {
        void 0 == i && (i = "");
        var a = $('<button class="ui button basic">' + WorkflowDesignerConstants.EditCodeLabel.EditCodeButton + "</button>");
        a[0].id = this.generateid(e.field, n), a[0].name = t.getElementCode(e), a[0].code = {}, a[0].code.code = decodeURIComponent(i);
        var r = o.Usings;
        r = void 0 == r ? t.parameters.graph.data.AdditionalParams.Usings.join(";") + ";" : decodeURIComponent(r), a[0].code.usings = r;
        var s = t.isReadOnly() ? ' readonly="true"' : "",
            l = $('<div class="ui large modal WorkflowDesignerDialogChild">');
        l[0].id = a[0].id + "_form", l.append('<div class="header">' + WorkflowDesignerConstants.EditCodeLabel.Title + "</div>");
        var d = $('<div class="content scrolling"></div>'),
            c = $('<a class="ui button">' + WorkflowDesignerConstants.EditCodeLabel.ShowUsings + "</a>");
        d.append(c);
        var h = $('<div id="' + a[0].id + '_usings" style="padding-top: 6px;display:none"/>');
        ...
        var m = $('<div class="actions"></div>');
        if (!WorkflowDesignerForm.isjava) {
            var g = $('<div class="ui button">' + WorkflowDesignerConstants.EditCodeLabel.Compile + "</div>");
            m.append(g), g.on("click", function () {
                for (var e = t.getEditData(t.parameters), i = void 0, n = 0; n < e.length; n++)
                    if (e[n].control_ActionCode.id == a[0].id) {
                        i = e[n];
                        break
                    }
                if (void 0 != i) {
                    i.ActionCode = encodeURIComponent(ace.edit(a[0].id + "_editor").getValue()), i.Usings = encodeURIComponent($("#" + a[0].id + "_usingsedit")[0].value.replace(/(\r\n|\n|\r)/gm, ""));
                    var o = function (e) {
                    ...
                    t.parameters.graph.designer.compile(i, o)
                }
            })
        }
        return a[0].readOnly ? m.append('<div class="ui secondary cancel button">' + WorkflowDesignerConstants.ButtonTextClose + "</div>") : (m.append('<div class="ui primary ok button">' + WorkflowDesignerConstants.ButtonTextSave + "</div>"), m.append('<div class="ui secondary cancel button">' + WorkflowDesignerConstants.ButtonTextCancel + "</div>")), l.append(m), a.on("click", function (e) {
            WorkflowDesignerCommon.modal(l, {
                closable: !1,
                allowMultiple: !0,
                onApprove: function () {
                    a[0].code = {}, a[0].code.code = ace.edit(a[0].id + "_editor").getValue(), a[0].code.usings = $("#" + a[0].id + "_usingsedit")[0].value.replace(/(\r\n|\n|\r)/gm, "")
                },
                onHidden: function () {
                    setTimeout(function () {
                        WorkflowDesignerCommon.modal(t.window, "show")
            ...
            var i = ace.edit(a[0].id + "_editor");
            $("#" + a[0].id + "_usingsedit")[0].value = t.htmlEncode(t.modifyUsingString(a[0].code.usings)), $("#" + a[0].id + "_usings").accordion({
                collapsible: !0,
                active: !1,
                heightStyle: "content scrolling"
            }), WorkflowDesignerConstants.isjava && (c.hide(), $("#" + a[0].id + "_usings").hide());
            var o = $("#" + t.generateid("Type", n))[0].value.toLowerCase(),
                r = $("#" + t.generateid("Name", n))[0].value,
                s = $("#" + t.generateid("IsAsync", n))[0].checked;
            r = "" === r ? "???" : "<b>" + r + "</b>";
            var d = "{";
            if (WorkflowDesignerConstants.isjava) "action" === o && (d = "function " + r + "(processInstance, runtime, parameter) {"), "condition" === o && (d = "function " + r + "(processInstance, runtime, parameter) {"), "ruleget" === o && (d = "function " + r + "(processInstance, runtime, parameter) {"), "rulecheck" === o && (d = "function " + r + "(processInstance, runtime, identityId, parameter) {");
            else {
                if ("action" === o) {
                ...
                "ruleget" === o && (d = "IEnumerable&lt;string&gt; " + r + " (ProcessInstance processInstance, WorkflowRuntime runtime, string parameter) {"), "rulecheck" === o && (d = "bool " + r + " (ProcessInstance processInstance, WorkflowRuntime runtime, string identityId, string parameter) {")
            }
            $("#" + a[0].id + "_function_upper").html(d);
            var i = ace.edit(a[0].id + "_editor");
            i.getSession().setMode(WorkflowDesignerConstants.isjava ? "ace/mode/javascript" : "ace/mode/csharp"), i.setValue(a[0].code.code), i.clearSelection(), t.isReadOnly() ? i.setOptions({
                readOnly: !0
            }) : (i.setOptions({
                readOnly: !1
        ...
        if (void 0 != e.datasource) {
            ...
            n = Array.isArray(e.datasource) ? function (t, n) {
                ...
                var o = e.datasource,
                    a = [];
                for (i = 0; i < o.length; i++) ~o[i].toLowerCase().indexOf(t) && a.push(o[i]);
                n(a)
            } : e.datasource;
            var o = {
                minChars: 0,
        ...
        return "input" == e.type ? e.control.value : "json" == e.type ? e.control.value : "code" == e.type ? e.control.code : "checkbox" == e.type ? "div" == e.control.localName ? e.control.children[0].checked : e.control.checked : "select" == e.type ? e.control.value : "textarea" == e.type ? e.control.value : void 0
        ...
        for (var n = e, o = t.split("."), a = 0; a < o.length; a++) {
            var r = o[a];
            a == o.length - 1 ? n[r] = i : (void 0 == n[r] && (n[r] = {}), n = n[r])
        }
        ...
        for (var n = this, o = !0, a = 0; a < e.length; a++)
            for (var r = a + 1; r < e.length; r++) this._checkUniqueEquals(e[a], e[r], t) && (t.forEach(function (t) {
                n.ControlAddError(e[a]["control_" + t], i), n.ControlAddError(e[r]["control_" + t], i)
            }), o = !1);
        return o
...
function WorkflowDesignerTransitionManager() {
    this.type = "WorkflowDesignerTransitionManager", this.init = function (e) {
        ...
        if (void 0 == t) {
            ...
            r.Draw(a.x + 10, a.y), this.batchDraw();
            var s = function (e) {
                ...
                l = function (t) {
                    ...
                    void 0 != o && i.CreateNewTransition(e, o), r.Delete(), i.graph.Stage.off("mousemove.WorkflowDesignerTransitionManagerTempControl", s), i.graph.Stage.off("mouseup.WorkflowDesignerTransitionManagerTempControl", l), i.batchDraw(), i.graph.StoreGraphData()
                };
        ...
        for (var i = e + "_" + t + "_", n = 1, o = 0; o < this.graph.data.Transitions.length; o++) {
            this.graph.data.Transitions[o].Name == i + n && (n++ , o = -1)
        }
        return i + n
    }
}
...
function WorkflowDesignerActivityControl(e) {
    var t = this;
    this.manager = e.manager, this.graph = e.graph, this.x = e.x, this.y = e.y, this.item = e.item, this.control = void 0, this.rectangle = void 0, this.text = void 0, this.createTransitionAndActivityButton = void 0, this.createTransitionButton = void 0, this.selected = !1, this.dependentTransitions = new Array, this.getX = function () {
        ...
        var o = WorkflowDesignerConstants.ActivityColor,
            a = WorkflowDesignerConstants.ActivityTextColor,
            r = !0;
        t.item.IsFinal && (o = WorkflowDesignerConstants.ActivityFinalColor, a = WorkflowDesignerConstants.ActivityFinalTextColor, r = !1), t.item.IsInitial && (o = WorkflowDesignerConstants.ActivityInitialColor, a = WorkflowDesignerConstants.ActivityInitialTextColor, r = !1), t.graph.GetCurrentActivity() == t.item.Name && (o = WorkflowDesignerConstants.SelectColor, a = WorkflowDesignerConstants.SelectTextColor, r = !1), t.graph.isCurrentActivityForSubprocess(t.item.Name) && (o = WorkflowDesignerConstants.SelectSubProcessColor, a = WorkflowDesignerConstants.SelectSubProcessTextColor, r = !1), t.rectangle = new Konva.Rect({
            x: 0,
            y: 0,
            ...
            fill: o,
            cornerRadius: 5
        }), t.control.add(t.rectangle), Array.isArray(t.item.Implementation) && t.item.Implementation.length > 0 && (t.impImage = new Konva.Image({
            x: t.rectangle.attrs.width - 20,
            y: 38,
            image: r ? t.manager.ImageImplementation : t.manager.ImageImplementationWhite,
            width: 15,
            height: 15
        }), t.control.add(t.impImage)), Array.isArray(t.item.PreExecutionImplementation) && t.item.PreExecutionImplementation.length > 0 && (t.impImage2 = new Konva.Image({
            x: t.rectangle.attrs.width - 35,
            y: 38,
            image: r ? t.manager.ImageImplementation : t.manager.ImageImplementationWhite,
            width: 15,
            height: 15
        }), t.control.add(t.impImage2)), t.text = new Konva.Text({
            x: 10,
            y: 10,
            text: this.GetName(),
            fontSize: 12,
            ...
            fontStyle: "bold",
            fill: a
        }), void 0 == t.item.State && (t.item.State = ""), t.stateText = new Konva.Text({
            x: 10,
            y: 25,
            text: t.item.State,
            fontSize: 12,
        ...
        var s = "";
        1 == t.item.IsInitial && (s.length > 0 && (s += " "), s += WorkflowDesignerConstants.ActivityFormLabel.IsInitial), 1 == t.item.IsFinal && (s.length > 0 && (s += " "), s += WorkflowDesignerConstants.ActivityFormLabel.IsFinal), 1 == t.item.IsForSetState && (s.length > 0 && (s += " - "), s += WorkflowDesignerConstants.ActivityFormLabel.IsForSetState), "" != s && (t.typeText = new Konva.Text({
            x: 10,
            y: 40,
            text: s,
            fontSize: 12,
            fontFamily: "Arial",
            fill: a
        }), t.control.add(t.typeText)), 1 == t.graph.getParam("exinfo") && t.createExInfo(t.control), t.graph.Settings.disableobjectmovements || (this.control.on("dragend", this.Sync), this.control.on("dragmove", this._onMove), this.control.on("click", this._onClick), this.control.on("touchend", this._onClick)), this.control.on("dblclick", this._onDblClick);
        var l = t.graph.Settings.imagefolder,
            d = [{
                img: l + "wfe.settings.png",
                click: function () {
                    t.ShowProperties()
                }
            }];
        t.graph.Settings.readonly || (d.push({
            img: l + "wfe.transition.png",
            click: function () {
                t._onCreateTransition()
            }
        }), d.push({
            img: l + "wfe.activity.png",
            click: function () {
            ...
            img: l + "wfe.delete.png",
            click: function () {
                t._onDelete()
            }
        }));
        var c = {
            x: t.rectangle.getWidth() - 30 * d.length,
            y: -40
        };
        t.bar = WorkflowDesignerBar(t.manager.Layer, d, c), t.control.add(t.bar), t.bar.hide(), t.manager.Layer.add(t.control)
        ...
        if (1 != this.selected) {
            var e = this;
            this.rectangle.setStrokeWidth(4), this.rectangle.setStroke(WorkflowDesignerConstants.SelectColor), e.bar != unescape && e.bar.show(), this.selected = !0
        }
    }, this.Deselect = function () {
        0 != this.selected && (this.rectangle.setStrokeWidth(0), this.rectangle.setStroke(this.rectangle.fill()), void 0 != t.bar && t.bar.hide(), this.selected = !1)
        ...
        if (i.x += e.x, i.y += e.y, this.control.setAbsolutePosition(i), this.Sync(), !(t.dependentTransitions.length < 1))
            for (var n = 0; n < t.dependentTransitions.length; n++) {
                var o = t.dependentTransitions[n];
                o.middle = void 0, o.Draw()
            }
        ...
        if (!(t.dependentTransitions.length < 1)) {
            ...
            for (var n = 0; n < t.dependentTransitions.length; n++) {
                var o = t.dependentTransitions[n];
                e && (o.middle = void 0, o.item.DesignerSettings = {}), o.Draw()
            }
        ...
        var e = WorkflowDesignerConstants.ActivityFormLabel,
            i = [{
                ...
                datasource: function (e, i) {
                    var n = $(this.element[0]).closest("tr"),
                        o = n.find("[name=impAction]")[0].value;
                    i(t.graph.getAutoCompleteSuggestions("actionparameter", o, e))
                }
            }],
            n = {
                type: "form",
                ...
                },
                {
                    ...
                    field: "State",
                    type: "select",
                    datasource: this.graph.getStateNames()
                }
                    //{
                    //name: e.State,
                    //field: "State",
            ...
            a = function (e, i) {
                var n = !0;
                return n &= e.CheckRequired([i], ["Name"], WorkflowDesignerConstants.FieldIsRequired), t.graph.data.Activities.forEach(function (o) {
            ...
            r = function (e) {
                return !!a(o, e) && (o.ClearTempField(e), t.item.Name = e.Name, t.item.State = e.State, t.item.IsInitial = e.IsInitial, t.item.IsFinal = e.IsFinal, t.item.IsForSetState = e.IsForSetState, t.item.IsAutoSchemeUpdate = e.IsAutoSchemeUpdate, t.item.Implementation = e.Implementation, t.item.PreExecutionImplementation = e.PreExecutionImplementation, WorkflowDesignerCommon.DataCorrection(t.graph.data), t.graph.Draw(t.graph.data), t.graph.StoreGraphData(), !0)
            };
        o.showModal(r)
    }, this.Sync = function () {
        void 0 == t.item.DesignerSettings && (t.item.DesignerSettings = {});
        var e = t.control.getPosition();
        t.item.DesignerSettings.X = e.x, t.item.DesignerSettings.Y = e.y, t.oldpos = void 0
        ...
        if (Array.isArray(t.item.PreExecutionImplementation) && t.item.PreExecutionImplementation.length > 0 && (t.item.PreExecutionImplementation.forEach(function (e) {
            ...
            if (e.add(o), n.length > 0) {
                var a = new Konva.Text({
                    x: 10,
                    y: this.graph.Settings.DefaultActivityHeight + o.getHeight() + 5,
                    text: n,
                    fontFamily: "Arial",
                    fontSize: 12,
                    fill: "#4A4A4A",
...
function WorkflowGraph(e, t, i, n) {
    var o = this;
    o.container = e, o.designer = t, o.suggestionsCache = new Object, void 0 == i && (i = new Object), void 0 == i.Container && (i.Container = "container"), void 0 == i.graphwidth && (i.graphwidth = 1024), void 0 == i.graphheight && (i.graphheight = 768), void 0 == i.DefaultActivityWidth && (i.DefaultActivityWidth = 200), void 0 == i.DefaultActivityHeight && (i.DefaultActivityHeight = 60), void 0 == i.DefaultMoveStep && (i.DefaultMoveStep = 10), void 0 == i.imagefolder && (i.imagefolder = "/images/"), this.Settings = i, this.Settings.ContainerStage = this.container + "_stage", $("#" + this.container).append("<div id='" + this.Settings.ContainerStage + "' class='workflowenginecontainerstage'></div>"), this.Stage = new Konva.Stage({
        ...
        o.data = e, 0 == o.graphData.length && o.StoreGraphData(), o.onSelectionChanged(), o.ComponentsExecute("draw")
        ...
        void 0 == o._bg && (o._bg = o.GetComponentByType("WorkflowDesignerBackground"));
        var i = o._bg.BackgroundLayer.getScale(),
            n = i.x + e;
        n > .3 && n < 2 && (o.ComponentsExecute("LayerScale", e), void 0 != t && o.ComponentsExecute("setPosition", t), o.redrawAll())
    }, this.GraphLayerScaleNorm = function () {
        o.ComponentsExecute("LayerScaleNorm"), o.redrawAll()
    }, this.GraphUpdatePosition = function (e) {
        void 0 == o._bg && (o._bg = o.GetComponentByType("WorkflowDesignerBackground")), o._bg.updatePosition(e), o.redrawAll()
    }, this.Refresh = function () {
        o.designer.refresh()
        ...
        if (e) {
            ...
            var n = $(window).width() - 2,
                o = $(window).height() - 2;
            this.Stage.hide(), this.Stage.width(n), this.Stage.height(o), void 0 != i && (i.setItemActive("fullscreen", !0), i.changeWidth(n)), t.css({
                position: "absolute",
                top: 0,
                left: 0,
                width: n,
        ...
        o.ComponentsExecute("DeselectAll"), o.onSelectionChanged(!1), o.redrawAll()
    }, this.SelectAll = function () {
        o.ComponentsExecute("SelectAll"), o.onSelectionChanged(!1), o.redrawAll()
    }, this.redrawAll = function () {
        void 0 == this._toolbal && (this._toolbal = o.GetComponentByType("WorkflowDesignerToolbar")), void 0 != this._toolbal && this._toolbal.draw(), o.Stage.batchDraw()
        ...
        if (void 0 == o.data || void 0 == o.data.AdditionalParams || !Array.isArray(o.data.AdditionalParams.SubprocessCurrentActivities)) return !1;
        for (var t = 0; t < o.data.AdditionalParams.SubprocessCurrentActivities.length; t++)
            if (e === o.data.AdditionalParams.SubprocessCurrentActivities[t]) return !0;
        return !1
        ...
        void 0 == this._toolbal && (this._toolbal = o.GetComponentByType("WorkflowDesignerToolbar"));
        var e = this._toolbal;
        void 0 != e && (e.setItemDisabled("undo", this.graphDataIndex <= 0), e.setItemDisabled("redo", this.graphData.length <= this.graphDataIndex + 1), e.Layer.batchDraw())
        ...
        if (void 0 != t) {
            var i;
            if (void 0 == e) {
                var n = o.GetComponentByType("WorkflowDesignerActivityManager"),
                    a = o.GetComponentByType("WorkflowDesignerTransitionManager"),
                    r = n.GetSelected(),
                    s = a.GetSelected();
                i = r.length > 0 || s.length > 0
            } else i = e;
            t.setItemDisabled("copy", !i), t.setItemDisabled("delete", !i)
        }
    }
}
...
function WorkflowDesignerTransitionControl(e) {
    var t = this;
    this.manager = e.manager, this.graph = e.graph, this.from = e.from, this.to = e.to, this.item = e.item, this.setFrom = function (e) {
    ...
    } : this.middle = void 0, this.from.RegisterTransition(this), this.to.RegisterTransition(this), this.start = void 0, this.end = void 0, this.angle = void 0, this.activePoint = void 0, this.touchpoints = [], this.DrawTransition = function (e, t) {
        var i, n, o, a, r = this,
            s = this.from.rectangle;
        this.to.rectangle;
        i = Number(this.from.getX()), n = Number(this.from.getY()), o = Number(this.to.getX()), a = Number(this.to.getY());
        var l = Number(s.attrs.width / 2),
            d = Number(s.attrs.height / 2),
            c = i + l,
            h = n + d,
            m = o + l,
            g = a + d;
        if (this.direction = {
            ...
            var u = !1;
            void 0 == this.middle && (u = !0, this.middle = {
                x: (c + m) / 2,
                y: (h + g) / 2
            });
            var p = c,
                ...
                v = m,
                y = g;
            if (h - d - 25 > this.middle.y && g - d - 25 > this.middle.y ? (f = h - d, y = g - d, this.direction.start = 1, this.direction.end = 1) : h + d + 25 < this.middle.y && g + d + 25 < this.middle.y ? (f = h + d, y = g + d, this.direction.start = 1, this.direction.end = 1) : c - l - 25 > this.middle.x && m - l - 25 > this.middle.x ? (p = c - l, v = m - l) : c + l + 25 < this.middle.x && m + l + 25 < this.middle.x ? (p = c + l, v = m + l) : (c + l + 25 < this.middle.x ? p += l : c - l - 25 > this.middle.x ? p -= l : h + d + 25 < this.middle.y ? (f += d, this.direction.start = 1) : h - d - 25 > this.middle.y ? (f -= d, this.direction.start = 1) : p <= this.middle.x ? p += l : p -= l, m + l + 25 < this.middle.x ? v += l : m - l - 25 > this.middle.x ? v -= l : g + d + 25 < this.middle.y ? (y += d, this.direction.end = 1) : g - d - 25 > this.middle.y ? (y -= d, this.direction.end = 1) : (f >= this.middle.y ? y += d : y -= d, this.direction.end = 1)), void 0 != e && (p = e.x, f = e.y, u = !0), void 0 != t && (v = t.x, y = t.y, u = !0), this.start = {
                x: p,
                y: f
            }, this.end = {
                x: v,
                ...
                for (var w = 0; w < r.manager.ItemControls.length; w++) {
                    var C = r.manager.ItemControls[w];
                    C != r && C.middle.x == r.middle.x && C.middle.y == r.middle.y && (0 == r.direction.start ? r.middle.y += 40 : r.middle.x += 40)
                }
            }
            void 0 == e && (0 == this.direction.start ? this.middle.y > f + d - 7 ? f += d - 7 : this.middle.y < f - d + 7 ? f -= d - 7 : f = this.middle.y : this.middle.x > p + l - 10 ? p += l - 10 : this.middle.x < p - l + 10 ? p -= l - 10 : p = this.middle.x), void 0 == t && (0 == this.direction.end ? this.middle.y > y + d - 7 ? y += d - 7 : this.middle.y < y - d + 7 ? y -= d - 7 : y = this.middle.y : this.middle.x > v + l - 10 ? v += l - 10 : this.middle.x < v - l + 10 ? v -= l - 10 : v = this.middle.x), this.start = {
                x: p,
                y: f
            }, this.end = {
                x: v,
        ...
        var b = this.GetColor();
        if (this.points = this.GetPoints([this.start.x, this.start.y, this.middle.x, this.middle.y, this.end.x, this.end.y], this.direction), this.angle = Math.atan2(this.points[this.points.length - 1] - this.points[this.points.length - 3], this.points[this.points.length - 2] - this.points[this.points.length - 4]), void 0 == this.control) {
            this.control = new Konva.Group({
                x: 0,
                y: 0,
                rotation: 0
            }), this.arrow = WorkflowDesignerCommon.createArrowByAngle(this.end.x, this.end.y, this.angle, 15, b);
            var S = {
                points: this.points,
                stroke: b,
                strokeWidth: 2,
            ...
            this.item.IsFork && (S.dash = [10, 10]), this.line = new Konva.Line(S), this.control.add(this.line), this.control.add(this.arrow), this.manager.Layer.add(this.control)
        } else WorkflowDesignerCommon.updateArrowByAngle(this.arrow, this.end.x, this.end.y, this.angle, 15, b), this.line.setPoints(this.points)
        ...
        if (1 != this.selected) {
            ...
            if (e.oldstroke = this.line.getStroke(), e.line.setStroke(WorkflowDesignerConstants.SelectColor), e.line.setStrokeWidth(3), void 0 == e.bar) {
                ...
                }), i = -30), e.bar = WorkflowDesignerBar(e.manager.APLayer, n, {
                    x: i,
                    y: -50
        ...
        var n = i ? {
            ...
            r = i ? 24 : 10;
        n.x == o.x ? n.y < o.y ? a.y = r : a.y = -r : n.y == o.y && (n.x < o.x ? a.x = r : a.x = -r), e.setPosition(n), e.circle.setPosition(a)
        ...
        var n = this,
            ...
            s = i ? 24 : 10;
        o.x == a.x ? o.y < a.y ? r.y = s : r.y = -s : o.y == a.y && (o.x < a.x ? r.x = s : r.x = -s);
        ...
        return l.on("dragmove", function () {
            ...
            void 0 != t && (n.middle = void 0, n.Sync(), i ? (n.to.UnregisterTransition(n), n.setTo(t), n.to.RegisterTransition(n)) : (n.from.UnregisterTransition(n), n.setFrom(t), n.from.RegisterTransition(n)), n.graph.StoreGraphData()), n.Draw(), n.manager.batchDraw()
        }), l
        ...
        var n = this,
            o = !n.graph.Settings.disableobjectmovements,
            a = new Konva.Group({
                x: e,
                y: t,
                draggable: o
        ...
        a.add(c), a.transition = i;
        var h = function (e, t) {
            var i = n.graph.CorrectPossition(a.getAbsolutePosition(), n.manager.Layer);
        ...
        if (a.on("click", m), a.on("touchend", m), a.on("dblclick", function () {
        ...
        }), 1 == n.graph.getParam("exinfo")) n.createExInfo(a);
        else {
            var g = this.item.Trigger.Type;
            void 0 != n.item.Trigger && void 0 != n.item.Trigger.Command && "Command" === n.item.Trigger.Type && (g += " " + n.item.Trigger.Command.Name), void 0 != n.item.Trigger && void 0 != n.item.Trigger.Timer && "Timer" === n.item.Trigger.Type && (g += " " + n.item.Trigger.Timer.Name), g += "\r\n" + this.item.Conditions[0].Type, void 0 != n.item.Conditions[0] && "Action" === n.item.Conditions[0].Type && (g += " " + n.item.Conditions[0].Action.ActionName), WorkflowDesignerTooltip(n.manager.APLayer, a, g, 17)
        }
        return a
    }, this.createExInfo = function (e) {
        var i = "";
        ...
        if (i.length > 0) {
            ...
            o.setX(-Number(o.getWidth() / 2)), e.add(o)
        }
        var a = "";
        if (Array.isArray(t.item.Conditions) && t.item.Conditions.length > 0 && t.item.Conditions.forEach(function (e) {
            if (void 0 != e.Action) {
                ...
                1 == e.ConditionInversion && (t = "(" + t + ")"), a.length > 0 && (a += ", "), a += t
            }
        }), a.length > 0) {
            var o = new Konva.Text({
                x: 0,
    ...
    }, this._getBendingKoeff = function (e, t, i, n, o, a) {
        var r = t - n,
            s = i - e,
            l = e * n - i * t;
        s <= 0 && (r = -r, s = -s, l = -l);
        ...
        var e = WorkflowDesignerConstants.TransitionFormLabel,
            i = {
                ...
                elements: [{
                    ...
                    elements: [{
                        ...
                        datasource: function (e, i) {
                            var n = $(this.element[0]).closest("tr"),
                                o = n.find("[name=conditionaction]")[0].value;
                            i(t.graph.getAutoCompleteSuggestions("conditionparameter", o, e))
                        }
                    }, {
                    ...
                    onrowadded: function (e) {
                        var t = e.find("[name=conditiontype]"),
                            ...
                            a = e.find("[name=conditioninversion]").parent(),
                            r = function () {
                                "Action" === t[0].value ? (i.show(), n.show(), o.show(), a.show()) : (i.hide(), n.hide(), o.hide(), a.hide())
                            };
                        t.on("change", r), r()
                    }
                }, {
                ...
                renderFinalFunc: function (e, t) {
                    var i = e.find("[name=restrictions]").parent(),
                        ...
                        o = e.find("[name=isfork]"),
                        a = e.find("[name=triggercommand]"),
                        ...
                        h = function () {
                            var e = function (e) {
                                ...
                                o = n[0].value;
                            "Command" == o ? (a.show(), e(a).show(), r.hide(), e(r).hide(), i.show()) : "Timer" == o ? (a.hide(), e(a).hide(), r.show(), e(r).show(), i.hide(), s.hide()) : (a.hide(), e(a).hide(), r.hide(), e(r).hide(), i.hide(), s.hide()), WorkflowDesignerCommon.modal(t.window, "refresh")
                        };
                    n.on("change", h), h();
                    var m = function () {
                        o[0].checked ? (d.show(), c.show()) : (d.hide(), c.hide())
                    };
                    o.on("change", m), m();
                    var g = s.find("[name=AllowConcatenationType]")[0].value.toLowerCase(),
                        u = s.find("[name=RestrictConcatenationType]")[0].value.toLowerCase(),
                        p = l.find("[name=ConditionsConcatenationType]")[0].value.toLowerCase();
                    "and" === g && "and" === u && s.hide();
                    var f = e.find("[name=restrictions]").parent(),
                    ...
                    }), f.append("&nbsp;"), f.append(v), "and" === p && l.hide();
            ...
            o = function (e, i) {
                ...
                var a = i.control_Conditions.parent().children("label");
                return !i.Conditions.length > 0 ? (a.attr("title", WorkflowDesignerConstants.TransitionFormLabel.ConditionsListShouldNotBeEmpty), a.css("cssText", "color: red !important;"), n = !1) : (a.attr("title", void 0), a.css("color", "")), t.graph.data.Transitions.forEach(function (o) {
                    o != t.item && o.Name == i.Name && (n = !1, e.ControlAddError(i.control_Name, WorkflowDesignerConstants.FieldMustBeUnique))
                }), e.CheckRequired(i.Restrictions, ["Type", "Actor.Name"], WorkflowDesignerConstants.FieldIsRequired) || (n = !1), n
            },
            a = function (e) {
                return !!o(n, e) && (n.ClearTempField(e), t.item.Name = e.Name, t.item.From = {
                    Name: e.From.Name
                }, t.item.To = {
                    Name: e.To.Name
                }, t.item.Classifier = e.Classifier, t.item.Restrictions = e.Restrictions, t.item.Trigger = e.Trigger, t.item.Conditions = e.Conditions, t.item.IsFork = e.IsFork, t.item.MergeViaSetState = e.MergeViaSetState, t.item.DisableParentStateControl = e.DisableParentStateControl, t.item.ConditionsConcatenationType = e.ConditionsConcatenationType, t.item.AllowConcatenationType = e.AllowConcatenationType, t.item.RestrictConcatenationType = e.RestrictConcatenationType, WorkflowDesignerCommon.DataCorrection(t.graph.data), t.graph.Draw(t.graph.data), t.graph.StoreGraphData(), !0)
            };
        n.showModal(a)
    }, this.Sync = function () {
        t.item.DesignerSettings.Bending = t.bending, void 0 != t.middle && (t.item.DesignerSettings.X = t.middle.x, t.item.DesignerSettings.Y = t.middle.y)
    }, this.destroy = function () {
...
function WorkflowDesignerActivityManager() {
    this.type = "WorkflowDesignerActivityManager", this.init = function (e) {
        this.graph = e, this.Layer = new Konva.Layer, this.graph.Stage.add(this.Layer), this.Layer.setZIndex(1), this.ImageImplementation = WorkflowDesignerCommon.loadImage(this.graph.Settings.imagefolder + "wfe.implementation.png"), this.ImageImplementationWhite = WorkflowDesignerCommon.loadImage(this.graph.Settings.imagefolder + "wfe.implementation.white.png")
    }, this.ItemControls = new Array, this.draw = function () {
        null != this.ItemControls && this.ItemControls.forEach(function (e) {
            e.destroy()
        }), this.ItemControls = new Array;
        ...
        void 0 != this.graph.data.Activities && this.graph.data.Activities.forEach(function (t) {
            ...
            e.ItemControls.push(a), a.Draw(), a.Sync()
        ...
        for (var t = 0; t < this.ItemControls.length; t++) {
            var i = this.ItemControls[t],
                ...
                o = n.x,
                a = n.y,
                r = o + i.rectangle.getWidth() * this.Layer.getScaleX(),
                s = a + i.rectangle.getHeight() * this.Layer.getScaleX();
            o < e.x1 && (e.x1 = o), a < e.y1 && (e.y1 = a), r > e.x2 && (e.x2 = r), s > e.y2 && (e.y2 = s)
        }
        return e
    }, this.GetSelected = function () {
        var e = new Array;
        ...
        this.graph = e, this.BackgroundLayer = new Konva.Layer, this.graph.Stage.add(this.BackgroundLayer), this.BackgroundLayer.setZIndex(0), this.SelectionLayer = new Konva.Layer, this.graph.Stage.add(this.SelectionLayer), this.SelectionLayer.setZIndex(1), WorkflowDesignerCommon.loadImage(this.graph.Settings.imagefolder + "wfe.grid.png", function (e) {
            ...
            dragBoundFunc: function (e) {
                var i = t.graph.Settings.DefaultMoveStep * t.BackgroundLayer.getScaleX(),
                    ...
                    a = t.BackgroundLayer.getScaleX(),
                    r = t.BackgroundLayer.getScaleY(),
                    s = t.graph.Stage.width() / a,
                    l = t.graph.Stage.height() / r;
                return t.RectBG.width() + e.x / a - s < 0 && t.RectBG.width(t.RectBG.width() + s), t.RectBG.height() + e.y / r - l < 0 && t.RectBG.height(t.RectBG.height() + l), t.graph.GraphLayerSetOffset(-o.x / a, -o.y / r), o
            },
...
function WorkflowDesignerTooltip(e, t, i, n, o) {
    t.destroyToolTip = function () {
        void 0 != this.ToolTip && (this.ToolTip.destroy(), this.ToolTip = void 0, e.batchDraw())
    };
    var a = function (e, t) {
    ...
    t.on("mouseover", function () {
        if (void 0 != t.ToolTip) {
            var o = a(t.getAbsolutePosition(), e);
            t.ToolTip.position({
                x: o.x + t.getWidth() / 2,
                y: o.y + n,
                opacity: 1
...
function WorkflowDesignerBar(e, t, i, n) {
    var o = "v" == n,
        ...
        r = new Konva.Rect({
            x: 0,
            y: 0,
            width: o ? 30 : 30 * t.length,
            height: o ? 30 * t.length : 30,
    ...
    return t.forEach(function (t) {
        if (t.offset = s, 1 == t.separator) {
            s += 10;
            var i = o ? [5, t.offset + 5, 25, t.offset + 5] : [t.offset + 5, 5, t.offset + 5, 25];
            ...
            }), t.group.add(t.cImageToolbar), a.add(t.group), void 0 != t.title && "" != t.title && WorkflowDesignerTooltip(e, t.cImageToolbar, t.title, 30), e.batchDraw()
        })
    }), 1 == o ? r.setHeight(s) : r.setWidth(s), a
}
...
function WorkflowDesignerToolbar() {
    ...
    var e = this;
    this.init = function (t) {
        this.graph = t, this.Layer = new Konva.Layer, this.graph.Stage.add(this.Layer), this.Layer.setZIndex(10), this.InitItems(), e.background = new Konva.Rect({
            x: 0,
            y: 0,
        ...
        this.MainToolbarDraw(0, 15), e.SideToolbar = WorkflowDesignerBar(e.Layer, e.SideItems, {
            x: e.graph.Settings.graphwidth - 60,
            y: 70
        }, "v"), e.Layer.add(e.SideToolbar), this.CreateInfoBlock({
            x: this.graph.Settings.graphwidth - 100,
            y: 2
        });
        var i = this.GetWorkflowDesignerBackground();
        void 0 != i && i.RectBG.setDraggable(!1), 1 == this.graph.getParam("movemodeenabled") && e.ToolbarMovePress(), 1 == this.graph.getParam("exinfo") && e.ToolbarExInfoPress()
    }, this.MainToolbarDraw = function (e, t) {
        var i = this,
            n = 0;
        this.Items.forEach(function (o) {
            o.offset = n, 1 == o.separator ? (n += 1, o.cObject = new Konva.Line({
                points: [e + o.offset, 0, e + o.offset, 50],
                stroke: WorkflowDesignerConstants.BarSeparatorColor,
                strokeWidth: 2
            }), i.Layer.add(o.cObject)) : (n += 50, WorkflowDesignerCommon.loadImage(o.img, function (n) {
                o.group = new Konva.Group({
                    x: e + o.offset,
                    y: t - 15,
                    width: 50,
                    height: 50
                    ...
                    height: 50,
                    cornerRadius: 0
                }), o.group.add(o.bg), 1 == o.active && o.bg.setFill(WorkflowDesignerConstants.ButtonActive), o.cImageToolbar = new Konva.Image({
                    x: 15,
                    y: 15,
                    image: n,
                    width: 20,
                    height: 20,
                    strokeWidth: 0
                }), 1 == o.disabled && o.cImageToolbar.opacity(.3), o.group.add(o.cImageToolbar), o.group.on("click", function () {
                    o.disabled !== !0 && void 0 != o.click && o.click(o)
                }), o.group.on("touchend", function () {
                    o.disabled !== !0 && void 0 != o.click && o.click(o)
                }), o.group.on("mouseover", function () {
                    1 != o.disabled && (o.bg.setFill(WorkflowDesignerConstants.ButtonActive), i.Layer.batchDraw())
                }), o.group.on("mouseleave", function () {
                    void 0 != o.active && 0 != o.active || (o.bg.setFill(""), i.Layer.batchDraw())
                }), i.Layer.add(o.group), WorkflowDesignerTooltip(i.Layer, o.group, o.title, 55, 0 == o.offset ? 20 : 0), i.Layer.batchDraw()
            }))
        })
    }, this.draw = function () {
        this.GraphRedrawAll()
        ...
        this.background.width(e), this.info.position({
            x: e - 100,
            y: 2
        ...
        this.infoText = new Konva.Text({
            ...
            fill: "black",
            x: 60
        }), this.info = new Konva.Group(e), this.info.add(this.infoText), this.info.add(this.infoTextValue), this.Layer.add(this.info)
        ...
        var e = 0,
            t = 0,
            i = 0;
        void 0 != this.graph.data && (e = this.graph.data.Activities.length, t = this.graph.data.Transitions.length, i = this.graph.data.Commands.length);
        var n = [e, t, i],
            o = "";
        return n.forEach(function (e) {
            for (var t = "", i = e.toString(), n = 0; n < 4 - i.length; n++) t += "  ";
            o.length > 0 && (o += "\r\n"), o += t + i
        }), o
        ...
        if (0 != e.graph.data.Activities.length) {
            var t = new Array;
            e.graph.data.Activities.forEach(function (e) {
                e.IsInitial && t.push(e)
            }), e.graph.data.Activities.forEach(function (i) {
                if (!i.IsInitial) {
                    for (var n = !0, o = 0; o < e.graph.data.Transitions.length; o++) {
                        var a = e.graph.data.Transitions[o];
                        if ("Direct" == a.Classifier && a.To == i) {
                            n = !1;
                            break
                        }
                    }
            ...
            }), 0 == t.length && t.push(e.graph.data.Activities[0]);
            var i = {
                x: 80,
                y: 120
            },
                ...
                a = function (t, i, r) {
                    ...
                    for (var l = new Array, d = 0; d < t.length; d++) {
                        var c = t[d];
                        void 0 == c.DesignerSettings && (c.DesignerSettings = {}), !r && $.inArray(c, o) >= 0 || (c.DesignerSettings.X = s.x, o.push(c), l.push(c))
                    }
            ...
            a(t, i, !0), e.graph.data.Transitions.forEach(function (e) {
                void 0 == e.DesignerSettings && (e.DesignerSettings = {}), e.DesignerSettings.X = void 0, e.DesignerSettings.Y = void 0
        ...
        if (0 != n.length || 0 != o.length) {
            ...
            n.forEach(function (t) {
                ...
                i.DesignerSettings.Y += 160, i.Name = e.CopySelectedGenUniqueValue(i.Name, e.graph.data.Activities, "Name"), a.push({
                    oldItem: t.item,
                    newItem: i
            ...
            o.forEach(function (t) {
                for (var i = t.item.From, n = t.item.To, o = 0; o < a.length; o++) i == a[o].oldItem && (i = a[o].newItem), n == a[o].oldItem && (n = a[o].newItem);
            ...
            }), WorkflowDesignerCommon.DataCorrection(e.graph.data), e.graph.Draw(e.graph.data), a.forEach(function (e) {
        ...
        var t = WorkflowDesignerConstants.LocalizationFormLabel,
            ...
            n = new WorkflowDesignerForm(i),
            o = function (t, o) {
                return !(!n.CheckRequired(t, ["ObjectName", "Type", "Culture", "Value"], WorkflowDesignerConstants.FieldIsRequired) || !n.CheckUnique(t, ["ObjectName", "Type", "Culture"], WorkflowDesignerConstants.FieldMustBeUnique)) && (n.ClearTempField(t), e.SyncTable(e.graph.data.Localization, t, i), e.graph.StoreGraphData(), !0)
            };
        n.showModal(o)
        ...
        var t = WorkflowDesignerConstants.TimerFormLabel,
            i = {
                ...
                elements: [{
                    ...
                    field: "Type",
                    type: "select",
                    datasource: this.graph.data.AdditionalParams.TimerTypes
                }, {
                    name: t.Value,
                    field: "Value",
                    type: "input"
            ...
            n = new WorkflowDesignerForm(i),
            o = function (t, o) {
                return !(!n.CheckRequired(t, ["Name", "Type", "Value"], WorkflowDesignerConstants.FieldIsRequired) || !n.CheckUnique(t, ["Name"], WorkflowDesignerConstants.FieldMustBeUnique)) && (n.ClearTempField(t), void 0 == e.graph.data.Timers && (e.graph.data.Timers = []), e.SyncTable(e.graph.data.Timers, t, i), e.graph.Draw(e.graph.data), e.graph.StoreGraphData(), !0)
            };
        n.showModal(o)
    }, this.EditActors = function () {
        var e = this,
            t = WorkflowDesignerConstants.ActorFormLabel,
            i = {
                type: "table",
                title: t.Title,
                width: "800px",
                ...
                elements: [{
                    ...
                    field: "Rule",
                    type: "select",
                    datasource: this.graph.getActorNames()
                }, {
                    name: t.Value,
                    field: "Value",
                    type: "select",
                    datasource: this.graph.getRoleNames()
                }
                    //{
                    //name: t.Value,
                    //field: "Value",
                    ...
                    //    var n = $(this.element[0]).closest("tr"),
                    //        o = n.find("[name=Rule]")[0].value;
                    //    i(e.graph.getAutoCompleteSuggestions("ruleparameter", o, t))
                    //}
                    //}
                ],
                graph: e.graph,
            ...
            n = new WorkflowDesignerForm(i),
            o = function (t, o) {
                return !(!n.CheckRequired(t, ["Name", "Rule"], WorkflowDesignerConstants.FieldIsRequired) || !n.CheckUnique(t, ["Name"], WorkflowDesignerConstants.FieldMustBeUnique)) && (n.ClearTempField(t), e.SyncTable(e.graph.data.Actors, t, i), e.graph.Draw(e.graph.data), e.graph.StoreGraphData(), !0)
            };
        n.showModal(o)
        ...
        var e = WorkflowDesignerConstants.ParameterFormLabel,
            t = this,
            i = function (e, i, n) {
                for (var o = void 0, a = e.getEditData(e.parameters), r = 0; r < a.length; r++) {
                    var s = a[r];
                ...
                void 0 != o && t.graph.designer.getemptytype(encodeURIComponent(o), n)
            },
            n = {
                type: "table",
                title: e.Title,
            ...
            o = function () {
                for (var e = $(d.window.find(".WorkflowDesignerTable"))[0], t = 0; t < e.rows.length; t++) {
                    var i = $(e.rows[t]),
            ...
            l = function (e, i) {
                if (d.CheckRequired(e, ["Name", "Type", "Purpose", "Parameter"], WorkflowDesignerConstants.FieldIsRequired) && d.CheckUnique(e, ["Name"], WorkflowDesignerConstants.FieldMustBeUnique)) {
                    d.ClearTempField(e), t.SyncTable(t.graph.data.Parameters, e, n);
                    for (var o = 0; o < t.graph.data.Parameters.length; o++) {
                        var a = t.graph.data.Parameters[o].Type;
                        t.graph.data.Parameters[o].Type = encodeURIComponent(a)
                    }
                    return t.graph.Draw(t.graph.data), t.graph.StoreGraphData(), !0
                }
                return !1
            },
            d = new WorkflowDesignerForm(n),
            c = $('<div class="ui slider checkbox"></div>'),
            h = $('<input type="checkbox" />');
        h.click(function (e, t) {
            h[0].checked ? a() : o(), WorkflowDesignerCommon.modal(d.window, "refresh")
        }), c.append(h), c.append("<label>" + WorkflowDesignerConstants.ParameterFormLabel.ShowSystemParameters + "</label>"), n.top.append(c), d.showModal(l), o(), s(), WorkflowDesignerCommon.modal(d.window, "refresh")
        ...
        var t = WorkflowDesignerConstants.CodeActionsFormLabel,
            i = {
                ...
                onrowadded: function (e, t) {
                    var i = e.find("[name=Type]");
                    i[0];
                    i.change(function () {
                        o(e)
                    }), o(e), e.find("[name=IsGlobal]").change(function () {
                        0 == this.checked && t.InfoDialog(WorkflowDesignerConstants.Warning, WorkflowDesignerConstants.CodeActionsFormLabel.UnGlobalMessage, "mini")
                    })
                },
                onrowdelete: function (e, t) {
                    e.find("[name=IsGlobal]")[0].checked && t.InfoDialog(WorkflowDesignerConstants.Warning, WorkflowDesignerConstants.CodeActionsFormLabel.GlobalDeleteMessage, "mini")
                }
            };
        WorkflowDesignerConstants.isjava || i.elements.push({
            name: t.IsAsync,
            field: "IsAsync",
            type: "checkbox"
        }), i.elements.push({
        ...
        var n = new WorkflowDesignerForm(i),
            ...
            a = function (t, o) {
                ...
                if (n.CheckRequired(t, ["Name", "Type", "ActionCode.code"], WorkflowDesignerConstants.FieldIsRequired) && n.CheckUnique(t, ["Name", "Type", "IsGlobal"], WorkflowDesignerConstants.FieldMustBeUnique)) {
                    n.ClearTempField(t);
                    var s = e.getGlobalCodeActionsForDelete(e.graph.data.CodeActions, t);
                    e.SyncTable(e.graph.data.CodeActions, t, i);
                    for (var l = 0; l < e.graph.data.CodeActions.length; l++) {
                        var d = e.graph.data.CodeActions[l].ActionCode;
                        e.graph.data.CodeActions[l].ActionCode = encodeURIComponent(d.code), WorkflowDesignerConstants.isjava || (e.graph.data.CodeActions[l].Usings = encodeURIComponent(d.usings))
                    }
                    return s.length > 0 && e.graph.designer.deleteGlobalCodeAction(s, function (e) {
                        return 1 == e.isError && n.InfoDialog(WorkflowDesignerConstants.EditCodeLabel.Error, e.errorMessage), !1
                    }), e.graph.Draw(e.graph.data), e.graph.StoreGraphData(), !0
                }
                return !1
            };
        n.showModal(a)
        ...
        return e.forEach(function (n) {
            if (n.IsGlobal) {
                for (var o = !1, a = 0; a < e.length; a++)
                    if (n.Name == e[a].Name && n.IsGlobal != e[a].IsGlobal) {
                        o = !0;
                        break
                    }
                for (var r = !1, a = 0; a < t.length; a++)
                    if (1 == o) {
                        if (n.Name == t[a].Name && t[a].IsGlobal) {
                            r = !0;
                            break
                        }
                    } else if (n.Name == t[a].Name) {
                        r = !0;
                        break
                    }
                0 == r && i.push(n.Name)
        ...
        var e = WorkflowDesignerConstants.CommandFormLabel,
            t = this,
            i = function (e, i, n) {
                for (var o = void 0, a = void 0, r = e.getEditData(e.parameters), s = 0; s < r.length; s++) {
                    var l = r[s];
                    if (void 0 != l.InputParameters)
                        for (var d = 0; d < l.InputParameters.length; d++)
                            if (l.InputParameters[d].control_DefaultValue.id === i.id) {
                                a = l.InputParameters[d].Parameter.Name;
                                break
                            }
                }
                if (void 0 != a)
                    for (var c = t.graph.data.Parameters, s = 0; s < c.length; s++)
                        if (c[s].Name === a) {
                            o = c[s].Type;
                            break
                        }
                void 0 != o && t.graph.graph.getemptytype(o, n)
            },
            n = {
                type: "table",
                title: e.Title,
                ...
                elements: [
                    ...
                    //}
                    {
                        ...
                        field: "Name",
                        type: "select",
                        datasource: this.graph.getCommandNames()
                    },
                    {
                        ...
                        elements: [
                            ...
                            , {
                                ...
                                type: "select",
                                displayfield: "Name",
                                datasource: this.graph.getNonSystemParameters()
                            }, {
            ...
            r = function (e) {
                return !!a(o, e) && (o.ClearTempField(e), t.SyncTable(t.graph.data.Commands, e, n), WorkflowDesignerCommon.DataCorrection(t.graph.data), t.graph.Draw(t.graph.data), t.graph.StoreGraphData(), !0)
            };
        o.showModal(r)
        ...
        i.showModal(n)
    }, this.Items = [], this.SideItems = [], this.InitItems = function () {
        var t = this.graph.Settings.imagefolder;
        this.graph.Settings.readonly || (this.Items.push({
            ...
            separator: !0
        })), this.graph.Settings.notshowwindows || (this.Items.push({
            ...
            separator: !0
        })), this.graph.Settings.disableobjectmovements || (this.Items.push({
            ...
            s.x += l.x, s.y += l.y, e.graph.GraphLayerScale(a, s)
        })
        ...
        for (var t = 0; t < this.SideItems.length; t++) {
            var i = this.SideItems[t];
            if (i.code == e) return i
        }
        ...
        if (void 0 == i.keyproperty) {
            ...
            for (var n = e.length - 1; n >= 0; n--) {
                var a = $.grep(t, function (t) {
                    return e[n][i.keyproperty] == t.keyproperty
                });
                0 == a.length ? e.splice(n, 1) : i.elements.forEach(function (t) {
                    e[n][t.field] = a[0][t.field]
                })
            }
            for (var n = 0; n < t.length; n++) {
                var a = $.grep(e, function (e) {
        ...
        for (var i = 0; i < this.Items.length; i++)
            if (this.Items[i].code == e) {
                this.Items[i].disabled = t, void 0 != this.Items[i].cImageToolbar && this.Items[i].cImageToolbar.opacity(1 == t ? .3 : 1);
                break
            }
        for (var i = 0; i < this.SideItems.length; i++)
            if (this.SideItems[i].code == e) {
                this.SideItems[i].disabled = t, void 0 != this.Items[i].cImageToolbar && this.Items[i].cImageToolbar.opacity(1 == t ? .3 : 1);
                break
            }
    }, this.setItemActive = function (e, t) {
        for (var i = 0; i < this.Items.length; i++)
            if (this.Items[i].code == e) {
                this.Items[i].active = t, void 0 != this.Items[i].bg && this.Items[i].bg.setFill(1 == t ? WorkflowDesignerConstants.ButtonActive : "");
                break
            }
        for (var i = 0; i < this.SideItems.length; i++)
            if (this.SideItems[i].code == e) {
                this.SideItems[i].active = t, void 0 != this.SideItems[i].bg && this.SideItems[i].bg.setFill(1 == t ? WorkflowDesignerConstants.ButtonActive : "");
                break
            }
    }
}
...
function WorkflowDesignerKeyboard() {
    this.type = "WorkflowDesignerKeyboard", this.init = function (e) {
        ...
        var e = this.graph.container,
            t = document.getElementById(e);
        t.onmouseover = void 0, t.onmouseout = void 0, document.removeEventListener("keydown", this._keyProcessing)
    }, this.keyProcessing = function (e) {
        if (this.ev !== !1) {
            const t = e.key;
            if ("Control" !== t) {
                var i = !1;
                return e.ctrlKey ? "a" == t ? this.graph.SelectAll() : "c" == t ? this.toolbarExec("CopySelected") : "e" == t ? this.toolbarExec("CreateActivity") : "i" == t ? this.toolbarExec("ToolbarExInfoPress") : "m" == t ? this.toolbarExec("ToolbarMovePress") : "y" == t ? this.graph.Redo() : "z" == t ? this.graph.Undo() : i = !0 : e.altKey && "Enter" == t ? this.graph.onFullScreenClick() : "Delete" == t ? this.graph.DeleteSelected() : "ArrowUp" == t ? this.objectsMove(0, -1) : "ArrowDown" == t ? this.objectsMove(0, 1) : "ArrowLeft" == t ? this.objectsMove(-1, 0) : "ArrowRight" == t ? this.objectsMove(1, 0) : i = !0, 0 == i ? void e.preventDefault() : void 0
            }
        }
    ...
    WorkflowDesignerCommon = {
        modal: function (e, t) {
            ...
            void 0 != e.semanticmodal ? i = "semanticmodal" : void 0 != e.modal ? i = "modal" : console.error("SemanticUI is not defined!"), void 0 != i && (e[i](t), void 0 == t || void 0 == t.onApprove && void 0 == t.onDeny || void 0 != e.keyup && e.keyup(function (n) {
                13 == n.keyCode ? void 0 != t.onApprove && 0 != t.onApprove() && e[i]("hide") : 27 == n.keyCode && (void 0 != t.onDeny ? 0 != t.onDeny() && e[i]("hide") : e[i]("hide"))
            }))
        },
        createArrowByAngle: function (e, t, i, n, o) {
            return void 0 == o && (o = "red"), new Konva.Wedge({
                x: e,
                y: t,
                radius: n,
                angle: 40,
        ...
        updateArrowByAngle: function (e, t, i, n, o, a) {
            void 0 == a && (a = "red"), e.setPosition({
                x: t,
                y: i
            }), e.setRadius(o), e.setFill(a), e.setRotation(180 * n / Math.PI - 200)
        },
        createUUID: function () {
        ...
        defineLocalStorage: function () {
            Object.defineProperty(window, "localStorage", new function () {
                ...
                Object.defineProperty(t, "getItem", {
                    ...
                    for (var o, a, r = 0, s = document.cookie.split(/\s*;\s*/); r < s.length; r++) o = s[r].split(/\s*=\s*/), o.length > 1 && (t[a = unescape(o[0])] = unescape(o[1]), e.push(a));
                    return t
        ...
        loadImage: function (e, t) {
            for (var i, n = 0; n < WorkflowDesignerCommon.imageCache.length; n++) {
                var o = WorkflowDesignerCommon.imageCache[n];
                if (o.src == e) {
                    i = o;
                    break
                }
            }
            return void 0 != i ? (void 0 != t && t(i), i) : (i = new Image, void 0 != t && (i.onload = function () {
                t(i)
            }), i.src = e, i)
        }
    };
! function (e, t, i, n) {
    "use strict";
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.semanticmodal = function (n) {
        var o, a = e(this),
            r = e(t),
            s = e(i),
            l = e("body"),
        ...
        return a.each(function () {
            var a, f, v, y, w, C, b, S, D, T = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.semanticmodal.settings, n) : e.extend({}, e.fn.semanticmodal.settings),
                k = T.selector,
                A = T.className,
                x = T.namespace,
                I = T.error,
            ...
            D = {
                initialize: function () {
                    D.verbose("Initializing dimmer", L), D.create.id(), D.create.dimmer(), D.refreshModals(), D.bind.events(), T.observeChanges && D.observeChanges(), D.instantiate()
                },
                instantiate: function () {
                    D.verbose("Storing instance of modal"), R = D, N.data(W, R)
                },
                create: {
                    dimmer: function () {
                        var t = {
                        ...
                        if (void 0 === e.fn.dimmer) return void D.error(I.dimmer);
                        D.debug("Creating dimmer"), y = L.dimmer(i), T.detachable ? (D.verbose("Modal is detachable, moving content into dimmer"), y.dimmer("add content", N)) : D.set.undetached(), w = y.dimmer("get dimmer")
                    },
                    id: function () {
                        b = (Math.random().toString(16) + "000000000").substr(2, 8), C = "." + b, D.verbose("Creating unique id for element", b)
                    }
                },
                destroy: function () {
                    D.verbose("Destroying previous modal"), N.removeData(W).off(P), r.off(C), w.off(C), F.off(P), L.dimmer("destroy")
                },
                observeChanges: function () {
                    "MutationObserver" in t && (S = new MutationObserver(function (e) {
                        ...
                        childList: !0,
                        subtree: !0
                    }), D.debug("Setting up mutation observer", S))
                },
                refresh: function () {
                    D.remove.scrolling(), D.cacheSizes(), D.set.screenHeight(), D.set.type(), D.set.position()
                },
                refreshModals: function () {
                    f = N.siblings(k.modal), a = f.add(N)
                },
                attachEvents: function (t, i) {
                    var n = e(t);
                    i = e.isFunction(D[i]) ? D[i] : D.toggle, n.length > 0 ? (D.debug("Attaching modal events to element", t, i), n.off(P).on("click" + P, i)) : D.error(I.notFound, t)
                },
                bind: {
                    events: function () {
                        D.verbose("Attaching events"), N.on("click" + P, k.close, D.event.close).on("click" + P, k.approve, D.event.approve).on("click" + P, k.deny, D.event.deny), r.on("resize" + C, D.event.resize)
                    }
                },
                get: {
                    id: function () {
                ...
                event: {
                    approve: function () {
                        if (O || T.onApprove.call(E, e(this)) === !1) return void D.verbose("Approve callback returned false cancelling hide");
                        O = !0, D.hide(function () {
                            O = !1
                        })
                    },
                    deny: function () {
                        if (O || T.onDeny.call(E, e(this)) === !1) return void D.verbose("Deny callback returned false cancelling hide");
                        O = !0, D.hide(function () {
                            O = !1
                        })
                    },
                    ...
                    click: function (t) {
                        var n = e(t.target),
                            o = n.closest(k.modal).length > 0,
                            a = e.contains(i.documentElement, t.target);
                        !o && a && (D.debug("Dimmer clicked, hiding all modals"), D.is.active() && (D.remove.clickaway(), T.allowMultiple ? D.hide() : D.hideAll()))
                    },
                    ...
                    resize: function () {
                        y.dimmer("is active") && (D.is.animating() || D.is.active()) && p(D.refresh)
                    }
                },
                toggle: function () {
                ...
                show: function (t) {
                    t = e.isFunction(t) ? t : function () { }, D.refreshModals(), D.set.dimmerSettings(), D.showModal(t)
                },
                hide: function (t) {
                    t = e.isFunction(t) ? t : function () { }, D.refreshModals(), D.hideModal(t)
                },
                showModal: function (t) {
                    t = e.isFunction(t) ? t : function () { }, D.is.animating() || !D.is.active() ? (D.showDimmer(), D.cacheSizes(), D.set.position(), D.set.screenHeight(), D.set.type(), D.set.clickaway(), !T.allowMultiple && D.others.active() ? D.hideOthers(D.showModal) : (T.allowMultiple && T.detachable && N.detach().appendTo(w), T.onShow.call(E), T.transition && void 0 !== e.fn.transition && N.transition("is supported") ? (D.debug("Showing modal with css animations"), N.transition({
                        debug: T.debug,
                        ...
                        useFailSafe: !0,
                        onComplete: function () {
                            T.onVisible.apply(E), T.keyboardShortcuts && D.add.keyboardShortcuts(), D.save.focus(), D.set.active(), T.autofocus && D.set.autofocus(), t()
                        }
                    })) : D.error(I.noTransition))) : D.debug("Modal is already visible")
                },
                hideModal: function (t, i) {
                    if (t = e.isFunction(t) ? t : function () { }, D.debug("Hiding modal"), T.onHide.call(E, e(this)) === !1) return void D.verbose("Hide callback returned false cancelling hide");
                    (D.is.animating() || D.is.active()) && (T.transition && void 0 !== e.fn.transition && N.transition("is supported") ? (D.remove.active(), N.transition({
                        ...
                        onComplete: function () {
                            T.onHidden.call(E), D.restore.focus(), t()
                        }
                    })) : D.error(I.noTransition))
                },
                showDimmer: function () {
                ...
                hideAll: function (t) {
                    var i = a.filter("." + A.active + ", ." + A.animating);
                    t = e.isFunction(t) ? t : function () { }, i.length > 0 && (D.debug("Hiding all visible modals"), D.hideDimmer(), i.semanticmodal("hide modal", t))
                },
                hideOthers: function (t) {
                    var i = f.filter("." + A.active + ", ." + A.animating);
                    t = e.isFunction(t) ? t : function () { }, i.length > 0 && (D.debug("Hiding other modals", f), i.semanticmodal("hide modal", t, !0))
                },
                others: {
                    active: function () {
                        return f.filter("." + A.active).length > 0
                    },
                    animating: function () {
                        return f.filter("." + A.animating).length > 0
                    }
                },
                add: {
                    keyboardShortcuts: function () {
                        D.verbose("Adding keyboard shortcuts"), s.on("keyup" + P, D.event.keyboard)
                    }
                },
                save: {
                    focus: function () {
                        v = e(i.activeElement).blur()
                    }
                },
                restore: {
                    focus: function () {
                ...
                remove: {
                    ...
                    keyboardShortcuts: function () {
                        D.verbose("Removing keyboard shortcuts"), s.off("keyup" + P)
                    },
                    scrolling: function () {
                        y.removeClass(A.scrolling), N.removeClass(A.scrolling)
                    }
                },
                cacheSizes: function () {
                    ...
                    }, D.cache.topOffset = -(D.cache.height / 2)), N.removeClass(A.loading), D.debug("Caching modal and container sizes", D.cache)
                },
                can: {
                    fit: function () {
                        var e = D.cache.contextHeight,
                            ...
                            a = T.padding,
                            r = t + i;
                        return n > o ? r + n + a < e : o + 2 * a < e
                    }
                },
                is: {
                    active: function () {
                        return N.hasClass(A.active)
                    },
                    animating: function () {
                ...
                set: {
                    ...
                    clickaway: function () {
                        T.closable && w.on("click" + C, D.event.click)
                    },
                    dimmerSettings: function () {
                        ...
                        var t = {
                            ...
                            i = e.extend(!0, t, T.dimmerSettings);
                        T.inverted ? (i.variation = void 0 !== i.variation ? i.variation + " inverted" : "inverted", w.addClass(A.inverted)) : w.removeClass(A.inverted), T.blurring ? y.addClass(A.blurring) : y.removeClass(A.blurring), L.dimmer("setting", i)
                    },
                    screenHeight: function () {
                    ...
                    scrolling: function () {
                        y.addClass(A.scrolling), N.addClass(A.scrolling)
                    },
                    type: function () {
                        D.can.fit() ? (D.verbose("Modal fits on screen"), D.others.active() || D.others.animating() || D.remove.scrolling()) : (D.verbose("Modal cannot fit on screen setting to scrolling"), D.set.scrolling())
                    },
                    position: function () {
                        D.verbose("Centering modal on page", D.cache), D.can.fit() ? N.css({
                            top: "",
                            marginTop: D.cache.topOffset
                        }) : N.css({
                            marginTop: "",
                            top: s.scrollTop()
                        })
                ...
                invoke: function (t, i, n) {
                    var a, r, s, l = R;
                    return i = i || u, n = E || n, "string" == typeof t && void 0 !== l && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function (i, n) {
                        var o = i != a ? n + t[i + 1].charAt(0).toUpperCase() + t[i + 1].slice(1) : t;
                        if (e.isPlainObject(l[o]) && i != a) l = l[o];
                        else {
                            if (void 0 !== l[o]) return r = l[o], !1;
                            if (!e.isPlainObject(l[n]) || i == a) return void 0 !== l[n] && (r = l[n], !1);
                            l = l[n]
                        }
                    })), e.isFunction(r) ? s = r.apply(n, i) : void 0 !== r && (s = r), e.isArray(o) ? o.push(s) : void 0 !== o ? o = [o, s] : void 0 !== s && (o = s), r
                }
            }, g ? (void 0 === R && D.initialize(), D.invoke(m)) : (void 0 !== R && R.invoke("destroy"), D.initialize())
        }), void 0 !== o ? o : this
    }, e.fn.semanticmodal.settings = {
        name: "Modal",
        namespace: "modal",
        silent: !1,
        debug: !1,
